...
Visit the [Wiki](https://github.com/milkybytes/DSChaosMod/wiki) for specific details on contributing to this application.

## Installing

1. Clone the repository using `git clone https://github.com/milkybytes/DSChaosMod.git`
